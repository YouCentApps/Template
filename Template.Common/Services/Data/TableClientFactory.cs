...
/// </summary>
public class TableClientFactory(Uri storageUri, string accountName, string accountKey) : ITableClientFactory
{
    private readonly Uri _storageUri = storageUri ?? throw new ArgumentNullException(nameof(storageUri));
